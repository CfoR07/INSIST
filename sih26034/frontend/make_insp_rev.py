...
# 2. Inspection.jsx
with open(os.path.join(src_dir, "Inspection.jsx"), "w", encoding="utf-8") as f:
...
# 3. Review.jsx
with open(os.path.join(src_dir, "Review.jsx"), "w", encoding="utf-8") as f:
    f.write("""import React, { useState, useEffect } from 'react'
...
print("Inspection.jsx and Review.jsx created")
